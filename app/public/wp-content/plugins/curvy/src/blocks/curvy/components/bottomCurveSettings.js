    ...
    <>
        ...
        <div style={{display: "flex"}}>
            <ToggleControl onChange={
                    (isChecked) => props.setAttributes({ bottomFlipX: isChecked })
                }
        ...
        <div style={{display: "flex"}}>
            <ToggleControl onChange={
                    (isChecked) => props.setAttributes({ bottomFlipY: isChecked })
                }
        ...
        <div style={{display: "flex"}}>
            ...
            <ColorPalette 
                ...
                onChange={(newColor) => props.setAttributes({ bottomColor: newColor })} 
            />
        </div>
    </>
    )
